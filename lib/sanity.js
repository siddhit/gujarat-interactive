...
// Write operations require a server-side API route so the token is never exposed to the browser.
// Submissions fall back to localStorage until a server endpoint is wired up.
const writeClient = null;
